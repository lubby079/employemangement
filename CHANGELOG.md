...
- Create Angular project with ng: `ng new employee_mangment.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`employee_mangment.client.esproj`).
